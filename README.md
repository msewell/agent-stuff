...
[![take my skill.md file… its really cool… it takes your agent… and makes it stupid](assets/alan-rice-skill-md.jpg)](https://x.com/alan__rice/status/2074722159453426036)

> take my skill.md file…  
> its really cool…  
> it takes your agent…  
> and makes it stupid
>
> — [Alan Rice (@alan__rice)](https://x.com/alan__rice/status/2074722159453426036), Jul 8, 2026
...
| [benchmarking-with-hyperfine](skills/benchmarking-with-hyperfine) | Designs, runs, interprets, and reports trustworthy command-line benchmarks using hyperfine. Chooses warmups, run counts, lifecycle hooks, shell control, parameter sweeps, exports, noise controls, and CI/Bencher integration. Use when benchmarking CLI commands or builds, comparing implementations, checking performance regressions, tuning hyperfine flags, or interpreting hyperfine JSON/Markdown results. |
| [markdown-section-summarizer](skills/markdown-section-summarizer) | Summarizes Markdown files section-by-section with strict sentence budgets derived from source section length. Use when you need deterministic per-section summary quotas, inventory-first workflows, and mechanical verification that each section has exactly floor(sqrt(n)) summary sentences. |
